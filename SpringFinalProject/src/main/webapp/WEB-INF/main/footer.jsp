        ...
        <div class="one_third">
            ...
            <article>
                <c:forEach var="vo" items="${tList }">
                    <p><a href="../food/food_detail.do?fno=${vo.fno }">${vo.name }</a>&nbsp;<span
                            style="color:orange">${vo.score }</span>(${vo.address })</p>
                </c:forEach>
            </article>
        </div>
        <!-- ################################################################################################ -->
...
<div class="wrapper row5">
    <div id="copyright" class="clear">
        ...
        <p class="fl_right">제작<a target="_blank" href="https://www.os-templates.com/" title="Free Website Templates">3강의장</a>
        </p>
        <!-- ################################################################################################ -->
    </div>
</div>
