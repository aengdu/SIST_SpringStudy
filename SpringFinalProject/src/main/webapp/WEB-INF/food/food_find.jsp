        ...
        <div class="row3">
            <div class="tex-center">
                <ul class="pagination">
                    ...
                    <li v-for="i in range(startpage, endpage)"><span class="btn btn-xs btn-default"
                                                                     v-on:click="pageChange(i)">{{i}}</span></li>
                    <li v-if="totalpage > endpage"><span class="btn btn-xs btn-default" v-on:click="next()">&gt;</span>
                    </li>
                </ul>
            </div>
        </div>
    ...
    new Vue({
        ...
        methods: {
            ...
            imageClick: function (no) {
                this.curpage = 1;
                let _this = this;
                axios.get("http://localhost:8080/web/food/food_find_gu_vue.do", {
                    params: {
                        page: this.curpage,
                        address: this.ss,
                        gu: no
